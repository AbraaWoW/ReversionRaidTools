...
RRT.BuffReminders.BUFF_TABLES = {
    ...
    pet = {
        ...
        },
        {
            ...
            customCheck = function()
                ...
                if RRT.BuffReminders.StateHelpers.GetPlayerSpecId() == 254 and not IsPlayerSpell(1223323) then
                    return nil
                end
                return not UnitExists("pet")
            end,
    ...
    consumable = {
        ...
        -- Weapon Buff (Off-Hand) - only shown when off-hand slot has a weapon
        {
            ...
            visibilityCondition = function()
                return RRT.BuffReminders.BuffState.HasOffHandWeapon()
            end,
        },
...
RRT.BuffReminders.BuffBeneficiaries = {
    intellect = {
        MAGE = true,
        WARLOCK = true,
        PRIEST = true,
