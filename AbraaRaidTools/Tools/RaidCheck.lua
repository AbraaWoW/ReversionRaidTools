...
local function BuildFrame()
    ...
    local f = CreateFrame("Frame", "ARTRaidCheckFrame", UIParent, "BackdropTemplate");
    f:SetSize(720, 450);
    ...
    title:SetText("Abraa Raid Check");
...
SLASH_ARTRAIDCHECK1 = "/artcheck";
SlashCmdList["ARTRAIDCHECK"] = function()
