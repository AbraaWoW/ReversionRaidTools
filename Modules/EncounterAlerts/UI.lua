...
local function BuildEncounterAlertsUI(parent)
    ...
    -- Build Assignments panel (mirrors Assignments > Midnight content)
    DF:BuildMenu(panels["assignments"], OptAssign.BuildMidnightOptions(), 10, -10, menuH, false,
        options_text_template, options_dropdown_template, options_switch_template,
        true, options_slider_template, options_button_template, OptAssign.BuildCallback())

    -- Build Custom panel
    RRT_NS.BuildCustomEncounterAlertsPanel(panels["custom"])
