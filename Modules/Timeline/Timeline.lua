...
function RRT_NS:CreateTimelineWindow()
    ...
    local timelineWindow = DF:CreateSimplePanel(UIParent, window_width, window_height,
        "|cFFBB66FFReversion|r Timeline", "RRTTimelineWindow", {
...
function RRT_NS:UpdateTimelineTitle()
    ...
    local title = "|cFFBB66FFReversion|r Timeline"
    ...
    if encID then
        ...
        if difficulty then
            title = string.format("|cFFBB66FFReversion|r Timeline - %s (%s)", bossName, difficulty)
        else
            title = string.format("|cFFBB66FFReversion|r Timeline - %s", bossName)
        end
    end
